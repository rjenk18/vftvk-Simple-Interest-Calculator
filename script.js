// Accept user input and calculate interest rate
function compute() {
...
// Update interest rate display based on range slider
function updateRate() {
    var rateval = document.getElementById("rate").value;
    document.getElementById("rate_val").innerText=rateval;
}

// Validate amount input to ensure a positive number has been entered
function checkData() {
    var principal = document.getElementById("principal").value;
    if (principal <= 0) {
